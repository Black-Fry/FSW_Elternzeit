...
--
-- Table structure for table `Tab_AdminUser`
--

DROP TABLE IF EXISTS `Tab_AdminUser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Tab_AdminUser` (
  `UserID` int(11) NOT NULL AUTO_INCREMENT,
  `UserName` varchar(30) COLLATE latin1_german2_ci NOT NULL DEFAULT '',
  `UserPass` varchar(32) COLLATE latin1_german2_ci NOT NULL DEFAULT '',
  `UserSession` varchar(32) COLLATE latin1_german2_ci DEFAULT NULL,
  `UserMail` varchar(150) COLLATE latin1_german2_ci NOT NULL DEFAULT '',
  `comment` varchar(25) COLLATE latin1_german2_ci DEFAULT NULL,
  PRIMARY KEY (`UserID`),
  UNIQUE KEY `NickName` (`UserName`),
  UNIQUE KEY `UserMail` (`UserMail`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Tab_AdminUser`
--

LOCK TABLES `Tab_AdminUser` WRITE;
/*!40000 ALTER TABLE `Tab_AdminUser` DISABLE KEYS */;
INSERT INTO `Tab_AdminUser` VALUES (60,'admin','161ebd7d45089b3446ee4e0d86dbcf92','','memento_mori666@web.de','Michas Test-Admin');
/*!40000 ALTER TABLE `Tab_AdminUser` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Tab_Familien` VALUES (1,'Müller','wWxtSfuWTsKnPTeC',0,'mueller@muell.orp','hans@wei.de'),(2,'Meier','EErW6uxW82YhV8PF',1,'frau_meier@gmail.com','herr_meier@gmail.com'),(3,'Lehmann','mgbk68EUHzJjMkEn',1,'lehmann1@web.de','lehmann2@web.de'),(4,'Burwitz, Röder','qpC9fu9VhP4DWE8j',0,'elisabeth.burwitz@gmail.com','mi@ossoelmi.berlin'),(8,'Däubler-Gmehlin','CYi6jPc8gknlXHfw',1,'mail@mail.de','mail@eins.zwei');
...
-- Dump completed on 2022-02-07 20:19:04
