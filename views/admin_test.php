...
/* TEST-Oberfläche - der Versand von mehr als 1 Mail sollte getestet werden
 * --> test abgebrochen, weil JS-Funktion prepare(..) zu viele Verzweigungen 
 *  mit sich brachte
 * alternative Tests mit zusätzlichen Test-Datensätzen in Produkvit-Tabelle waren erfolgreich
 */
...
{       
    ...
    $families = DBclass::query("SELECT * FROM " . T_FAM_TEST . ";\"")->all();
...
//print_r($loginResult);
if (! $loginResult) 
{   header('Location: ' . ADMIN_TEST_LOGIN_URL); }
